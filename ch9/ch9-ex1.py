...
def main():
    ...
    matchWinsA, matchWinsB, totalWinsA, totalWinsB = simMMatches(probA, probB, m, n)
    printSummary(matchWinsA, matchWinsB, totalWinsA, totalWinsB, m, n)
...
def simMMatches(probA, probB, m, n):
    ...
    return totalMatchWinsA, totalMatchWinsB, totalWinsA, totalWinsB
...
def printSummary(matchWinsA, matchWinsB, winsA, winsB, m, n):
    print("\nMatches simulated:", m)
